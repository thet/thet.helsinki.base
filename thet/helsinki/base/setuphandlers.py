...
def setup_content(context):
    ...
    content_structure = [
        ...
        {'type': 'Folder', 'title': u'Programm',
         'opts': {'setLayout': 'traverse_view',
                  'setLocallyAllowedTypes': ['Folderish Document', 'Folder', 'Link'],
                  'setImmediatelyAddableTypes': ['Folderish Document', 'Folder', 'Link']},
         'childs': [
    ...
    try:
        ...
        sort_crit = topic.addCriterion('getObjPositionInParent','ATSortCriterion')
